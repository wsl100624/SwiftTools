//
//  JMGListHeaderFooterController.swift
//  
//
//  Created by Will Wang on 3/17/21.
//
...
open class JMGListHeaderFooterController<T: JMGListCell<U>, U, H: UICollectionReusableView, F: UICollectionReusableView>: UICollectionViewController {

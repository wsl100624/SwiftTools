...
open class JMGListHeaderController<T: JMGListCell<U>, U, H: UICollectionReusableView>: JMGListHeaderFooterController<T, U, H, UICollectionReusableView> {
}
